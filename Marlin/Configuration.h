...
#define STRING_CONFIG_H_AUTHOR "(Charles, Tronxy X5SA Pro w/BigTreeTech SKR2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR2 w/BTT Smart Filament"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "cha41e500-0001-41ae-8762-5ce5bbf791a7"
 ...
 */
 // At full power, bed draws 11.1 A. Desired is 10A. 255 / 11.1 * 10 = 229.72
#define MAX_BED_POWER 225 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 36.12
  #define DEFAULT_bedKi 36.12
  #define DEFAULT_bedKd 674.44
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 794 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48.8, -8, -0.9 }
...
#define X_BED_SIZE 326
#define Y_BED_SIZE 318

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -0.4
#define Y_MIN_POS 0
#define Z_MIN_POS 0
